...
import org.tasknavi.ui.MainGlobalSearchBar;
import org.tasknavi.ui.MainHeaderBar;
import org.tasknavi.ui.MainTabChrome;
import org.tasknavi.ui.MainTaskAddHelper;
import org.tasknavi.ui.MainThemeSupport;
import org.tasknavi.ui.MainToolbarButtons;
import org.tasknavi.ui.TaskDataIoHelper;
import org.tasknavi.ui.TaskDeleteHelper;
...
public class MainFrame extends JFrame {
    ...
    private JPanel createToolBarPanel() {
        ...
        refreshButton.addActionListener(e ->
                TaskEventBus.getInstance().post(
                        new org.tasknavi.event.TaskEvent(org.tasknavi.event.TaskEvent.Type.REFRESH_ALL, null)));
        ...
        rightSearchGroup.add(globalSearchBar.createFilterSummaryLabel());
    ...
    private void handleExport() {
        TaskDataIoHelper.exportTasks(this, taskService, globalSearchBar.keyword(), globalSearchBar.status());
    }
